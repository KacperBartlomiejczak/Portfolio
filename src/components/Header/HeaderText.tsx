  ...
  return (
    <div className="p-2 flex flex-col justify-center items-center   md:ml-6 md:items-start">
      ...
      <p className="text-sm text-center px-2 md:text-left  md:px-0 md:text-wrap md:text-lg/relaxed text-balance text-white">
        I don’t just code websites — I create engaging digital experiences. As a
        front-end developer with a strong eye for detail, I ensure every project
        is pixel-perfect, optimized, and user-friendly. If you need a site that
        stands out, <span className="text-[#ce4a4b]">I’m your guy!</span>
      </p>
    </div>
  );
}
