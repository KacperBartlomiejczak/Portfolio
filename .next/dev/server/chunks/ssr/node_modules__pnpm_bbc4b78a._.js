...
"[project]/node_modules/.pnpm/marked@16.4.1/node_modules/marked/lib/marked.esm.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
` ? t[1].slice(0, -1) : t[1];
    ...
    emStrong(e, t, n = "") {
        ...
        if (!(r[1] || r[2] || "") || !n || this.rules.inline.punctuation.exec(n)) {
            let s = [
                ...r[0]
            ].length - 1, o, a, l = s, c = 0, p = r[0][0] === "*" ? this.rules.inline.emStrongRDelimAst : this.rules.inline.emStrongRDelimUnd;
                ...
                for(let s in n.hooks){
                    ...
                    S.passThroughHooks.has(s) ? i[o] = (c)=>{
                        ...
                        if (this.defaults.async) return (async ()=>{
                            ...
                            return g === !1 && (g = await l.apply(i, c)), g;
                        })();
                        let p = a.apply(i, c);
                        return p === !1 && (p = l.apply(i, c)), p;
                    };
...
//# sourceMappingURL=node_modules__pnpm_bbc4b78a._.js.map